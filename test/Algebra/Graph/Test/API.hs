...
adjacencyMapPocAPI = API
    ...
    , edges                      = AMPoc.edges
    , overlays                   = AMPoc.overlays
    , connects                   = AMPoc.connects
    -- , toGraph                    = T.toGraph
    -- , foldg                      = T.foldg
    -- , isSubgraphOf               = AM.isSubgraphOf
    ...
    , vertexSet                  = AMPoc.vertexSet
    -- , vertexIntSet               = T.vertexIntSet
    , edgeSet                    = AMPoc.edgeSet
    -- , preSet                     = AM.preSet
    -- , preIntSet                  = T.preIntSet
    -- , postSet                    = AM.postSet
    -- , postIntSet                 = T.postIntSet
    ...
    , replaceVertex              = AMPoc.replaceVertex
    , mergeVertices              = AMPoc.mergeVertices
    -- , transpose                  = AM.transpose
    , gmap                       = AMPoc.gmap
    -- , induce                     = AM.induce
    -- , induceJust                 = AM.induceJust
